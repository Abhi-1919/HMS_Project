...
<body>
	<div class="container"><br/>
		...
		<div class="row">
			<div class="col-sm-5">
			<h1><span style="color:grey;">SARASWATI</span><span style="color:red;"> APPLE</span></span> HOSPITAL</h1>
			</div>
			<div class="col-sm-7">
			<p><b>Dr. Rajesh Kuber Madnaik</b><br/> MBBS,MD(Gen. Surgeon)</p>
			</div>
		</div>
		<hr/>
	<div class="demo">
			...
			<div>
				...
				<hr/>
				Our Centers:<br/>
			    1. Saraswati Apple Hospital, Dabholkar Corner, Kolhapur, Maharashtra 416001 |
			    2. D.Y Patil Multispeciality Hospital, Kadamwadi, Kolhapur, Maharashtra 416003<br/>
			    Mobile No. 8964775757 | Phone No. 0231-2575151 | E-mail: drrajeshmadnaik@gmail.com	
			</div>	
	
	</div><br/><br/>
	<div class="copyright">
                                 
   <p> <marquee direction="left" scrollamount="4">EduBridge Final Project from 7891-Batch CG.AWS-Mumbai</marquee>
       &copy;ABHINANDAN,PRATIKSHA,MITALI,AADESH,LAUKIK,SAURABH 2022. All rights reserved.</p>
